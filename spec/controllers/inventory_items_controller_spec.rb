...
RSpec.describe InventoryItemsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested inventory_item as @inventory_item" do
      inventory_item = InventoryItem.create! valid_attributes
      get :show, {:id => inventory_item.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested inventory_item as @inventory_item" do
      inventory_item = InventoryItem.create! valid_attributes
      get :edit, {:id => inventory_item.to_param}, valid_session
      expect(assigns(:inventory_item)).to eq(inventory_item)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created inventory_item" do
        post :create, {:inventory_item => valid_attributes}, valid_session
        expect(response).to redirect_to(InventoryItem.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved inventory_item as @inventory_item" do
        post :create, {:inventory_item => invalid_attributes}, valid_session
        expect(assigns(:inventory_item)).to be_a_new(InventoryItem)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested inventory_item" do
        inventory_item = InventoryItem.create! valid_attributes
        put :update, {:id => inventory_item.to_param, :inventory_item => new_attributes}, valid_session
